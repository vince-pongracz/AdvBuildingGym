...
# Usage: python preproc/e_price/price_augment.py data/e_price/price_data_2023_norm.csv -o data/e_price/price_data_2023_aug.csv
#        python preproc/e_price/price_augment.py data/e_price/price_data_2023_norm.csv --noise-std 0.5 --seed 42
