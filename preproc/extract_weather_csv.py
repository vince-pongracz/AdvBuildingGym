...
Usage:
    python -m preproc.extract_weather_csv
    # or
    python preproc/extract_weather_csv.py
    # or with custom input file
    python preproc/extract_weather_csv.py --input data/zenodo/2018_weather.hdf5
"""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        "-o",
        type=str,
        default="data/zenodo/csvs_weather",
        help="Output directory for CSV file (default: data/zenodo/csvs_weather)",
    )
    parser.add_argument(
        "--config",
        "-c",
    ...
    if input_file is None:
        ...
        if input_file is None or "weather" not in input_file.lower():
            input_file = "data/zenodo/2018_weather.hdf5"
