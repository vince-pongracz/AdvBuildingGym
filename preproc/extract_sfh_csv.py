...
Usage:
    python -m preproc.extract_sfh_csv
    # or
    python preproc/extract_sfh_csv.py
    # or with custom input file
    python preproc/extract_sfh_csv.py --input data/zenodo/2018_data_1min.hdf5
"""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help=f"Path to HDF5 input file (default: from {f_name} or data/zenodo/2018_data_1min.hdf5)",
    )
    parser.add_argument(
        "--output",
        "-o",
        type=str,
        default="data/zenodo/csvs",
        help="Output directory for CSV files (default: data/zenodo/csvs)",
    )
    parser.add_argument(
        "--group",
        "-g",
    ...
    if input_file is None:
        input_file = "data/zenodo/2018_data_1min.hdf5"
