...
# NOTE VP 2026.02.28. : Usage: python preproc/awattar_price_preproc.py data/2023_prices.csv [-o data/2023_prices_preproc.csv]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-o", "--output",
        default=None,
        help="Output CSV path (default: data/price_data_<year>.csv)",
    )
    ...
    if output_path is None:
        ...
        output_path = f"data/price_data_{year}_norm.csv"
