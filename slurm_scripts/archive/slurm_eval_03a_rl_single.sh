...
#     chmod +x slurm_script/slurm_eval_03a_rl_single.sh
#
# - Submit the evaluation job with:
#     sbatch slurm_script/slurm_eval_03a_rl_single.sh <algorithm>
#
# Arguments:
...
#
# Example usage:
#     sbatch slurm_script/slurm_eval_03a_rl_single.sh ppo
#     sbatch slurm_script/slurm_eval_03a_rl_single.sh sac
#     sbatch slurm_script/slurm_eval_03a_rl_single.sh ddpg
#     sbatch slurm_script/slurm_eval_03a_rl_single.sh a2c
#
# Output:
